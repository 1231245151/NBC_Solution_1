...
void main()
{
	...
	while (true)
	{
		...
		{
		case 1:
			HealStat(20, &Status[0], &HPPotion);
			break;
		case 2:
			HealStat(20, &Status[1], &MPPotion);
			break;
		case 3:
			DoublePowerUP(&Status[2]);
			break;
		case 4:
			DoublePowerUP(&Status[3]);
			break;
		case 5:
			printf("\n<현재 스텟>\n");
			printf("Level : %d HP : %d MP : %d ATK : %d DEF : %d\n<보유중인 포션>\nHP포션 : %d MP포션 : %d\n\n", Level, Status[0], Status[1], Status[2], Status[3], HPPotion, MPPotion);
			break;
		case 6:
